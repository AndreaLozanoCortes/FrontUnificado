...
const mostrarAlertas = (alerta) =>{
  switch (alerta){
    case 'eliminado':
      Swal.fire({
        title: '¡Eliminado!',
        text: "El destino se eliminó con éxito",
        icon: 'success',
    ...
    case 'error':
      Swal.fire({
        title: 'Error',
        text:  'No se pudo eliminar el destino',
        icon: 'error',
        confirmButtonColor: '#3085d6',
        confirmButtonText: 'Ok'
      });
  ...
  let results = []
   if(!busqueda){
       results = registros
        ...
        dato.id_cuenta.toString().includes(busqueda.toLocaleLowerCase()) || 
        dato.id_informe_financiero.toString().includes(busqueda.toLocaleLowerCase()) 
        )
   };
      ...
      cell: (row) => (
        <>
          ...
          <button
            ...
            title="Eliminar"
            onClick={() => {
              setRegistroDelete(row.id_destino_cuenta);
              abrirModalEliminar();
            }}
          >
        ...
        <div className="col-4">
          <div className="input-group flex-nowrap">
            ...
            <input
              ...
              type="text"
              placeholder="Buscar por cuenta o informe financiero..."
              aria-label="Search"
              value={busqueda}
