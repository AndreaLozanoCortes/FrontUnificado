...
const mostrarAlertas = (alerta) =>{
  switch (alerta){
    case 'eliminado':
      Swal.fire({
        title: '¡Eliminado!',
        text: "El modo pedido se eliminó con éxito",
        icon: 'success',
    ...
    case 'error':
      Swal.fire({
        title: 'Error',
        text:  'No se pudo eliminar el modo pedido',
        icon: 'error',
        confirmButtonColor: '#3085d6',
        confirmButtonText: 'Ok'
      });
...
export default MostrarModoPedido;
